...
{phang2}Where {it:numlist} is a list of desired numbers of clusters or average cluster sizes to simulate.  
...
{phang}Main author: Jonathan Seiden (jseide@g.harvard.edu)
