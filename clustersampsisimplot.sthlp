...
{phang2}{cmdab:clustersampsim} {hline 2} simulates cluster-randomized trial sample size requirements for a given range of numbers of clusters or average cluster sizes

{title:Syntax}

{phang2}
{cmdab:clustersampsim}, {cmdab:grpv:ar(}{it:varname}{cmd:)} {c -(} {cmdab:save(}{it:{help filename}}{cmd:)} | {cmdab:savet:ex(}{it:{help filename}}{cmd:)} | {cmdab:browse} {c )-}
